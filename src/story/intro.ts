...
export const INTRO_SCENE: ScriptScene = {
  ...
  lines: [
    ...
    narrate("On the docks of a town the maps call merely ‘the fourth town’, a small concern called Hextall Freight is hiring — one job, badly paid, and in writing."),
    say("mabel", "Mind the step, boss. Your office is where it always was: above the dock, under the leak, behind the ledger. The sign on the door says Logistics Manager. That is you, as of this morning.", "calm", "boardroom"),
    ...
    say("player", "First day back at work. How bad is it, Mabel?"),
    ...
    say("griev", "The chair recognises the new Logistics Manager. The Syndicate will watch your career with interest. Interest, Hextall, is a charge.", "calm", "boardroom"),
