...
import {
  ...
  obstacleIntroLine, recordTuningCleared, retuneOwed, rivalTuningGold, rivalTuningYield,
  settleTuningYield, sessionObstacles as sessionObstaclesFor, takeTuningMove,
  tuningMovesLeft, tuningOver, tuningSessionGold, tuningSessionYield,
      ...
      tuning: newLoop
        ? (tuning
          ? {
              ...
              score: tuning.score, yield: tuningSessionYield(tuning, difficultyRules().minYield),
              abandonYield: abandonYieldFor(difficultyRules()),
            }
          : null)
        : undefined,
