    ...
    // ── 1 ────────────────────────────────────────────────────────────────
    {
      ...
      steps: [
        ...
        },
        {
          ...
          target: { kind: "ui", selector: '[data-act="recenter"], #iso-menu-btn' },
          complete: { kind: "click", selector: '[data-act="recenter"]' },
          next: true,
          assist: { kind: "recenter" },
        },
        {
          id: "topbar",
          title: "The top bar",
    ...
    // ── 3 ────────────────────────────────────────────────────────────────
    {
      ...
      steps: [
        ...
        },
        {
          ...
          voice: "n-tuning",
          target: { kind: "ui", selector: "#iso-session, #iso-plant" },
    ...
    // ── 7 ────────────────────────────────────────────────────────────────
    {
      ...
      steps: [
        ...
        },
        {
          ...
          voice: "g-drawer-bank",
          target: { kind: "ui", selector: '[data-tab="bank"], .bank-pane' },
          complete: { kind: "tab", tab: "bank" },
          next: true,
          assist: { kind: "tab", tab: "bank" },
        },
        ...
        },
        {
          ...
          target: { kind: "ui", selector: '[data-tab="black"], .black-pane' },
        ...
        },
        {
          ...
          voice: "g-drawer-feed",
          target: { kind: "ui", selector: '[data-tab="feed"], .feed-pane' },
        ...
        },
        {
          ...
          target: { kind: "ui", selector: '[data-tab="quests"], .quests-pane' },
