      ...
      steps: [
        {
          ...
          target: { kind: "ui", selector: '[data-tool="dirt"], [data-tool="street"], [data-tool="road"], [data-tool="highway"], [data-group="roads"]' },
      ...
      steps: [
        {
          ...
          voice: "n-rail",
          target: { kind: "ui", selector: '[data-tool="rail"], [data-group="rails"]' },
        ...
        },
        {
          ...
          voice: "n-platform",
          target: { kind: "ui", selector: '[data-tool="platform"], [data-group="rails"]' },
