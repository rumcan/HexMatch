...
export function buildTutorialSteps(ctx: TutorialContext): TutorialStep[] {
  ...
  return [
    ...
    },
    {
      ...
      points: [
        "<b>Left button</b> places and drags roads; <b>middle button</b> pans (one finger drags the map on touch, two pinch-zoom); <b>wheel</b> zooms; 🎯 recentres on your plant.",
        "Left column: <b>Build</b> — Dirt Road, Road, Depot, Processing Plant, Demolish (half refund) — and the <b>Black Market</b> beneath it.",
        ...
        "<b>Esc</b> cancels an armed card or protest, <b>M</b> mutes, and ♻ collapses the board for a fresh neutral one (30 s cooldown).",
      ],
