...
| Board | 48px nearest-neighbour pixel gems | six 144px hand-painted cargo tokens, matted to a circle so they sit on the baize like struck chips, brass selection ring under the lamp |
...
```bash
npm run noir-art          # → src/assets/ui/noir/, src/assets/gems/
