...
function running() {
  ...
  const source = placePlatform(state, "you", 1, 7, 2, "sw", { kind: "industry", id: 0, tiles: [] });
  const dest = placePlatform(state, "you", 1, 17, 2, "sw", { kind: "plant", id: 0, tiles: [] });
  buildRail(grid, track, state, 1, row(3, 7, 19));
